...
class HkmoEklenti:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Hkmo Eklenti')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('HkmoEklenti', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/hkmo_eklenti/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'en kisa yolu bulur'),
            callback=self.run,
